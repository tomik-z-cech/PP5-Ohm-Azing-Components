...
urlpatterns = [
    ...
    path('item-like/<int:item_pk>/', login_required(views.ItemLikeView.as_view()), name='item-like'),
    path('item-dislike/<int:item_pk>/', login_required(views.ItemDislikeView.as_view()), name='item-dislike'),
]
