...
from owner.widgets import (
    CustomImageInputCategory,
    CustomImageInputItem1,
    CustomImageInputItem2,
    CustomImageInputItem3,
)
...
class CategoryForm(forms.ModelForm):
    ...
    category_image = forms.ImageField(
        label="Category Image", required=False, widget=CustomImageInputCategory
    )
...
class ItemForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["item_sku"].widget.attrs.update(
            {"placeholder": "Enter item SKU (required)"}
        )
    ...
    image_1 = forms.ImageField(
        label="Image 1", required=False, widget=CustomImageInputItem1
    )
    image_2 = forms.ImageField(
        label="Image 2", required=False, widget=CustomImageInputItem2
    )
    image_3 = forms.ImageField(
        label="Image 3", required=False, widget=CustomImageInputItem3
    )
