...
class UserProfileForm(forms.ModelForm):
    ...
    marketing_phone = forms.BooleanField(label='Can we contact you via phone ?', required=False)
    marketing_email = forms.BooleanField(label='Can we contact you via Email ?', required=False)
